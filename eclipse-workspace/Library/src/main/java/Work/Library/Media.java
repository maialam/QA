...
public class Media extends LibraryItems{
	...
	public Media(int identity, String equipmentName, String mediaType, boolean checkOut, boolean checkIn, String addItem, boolean removeItem, String updateItem) {
